...
//---------------------------------------------------------------------------
bool BoundingOBB::CheckVisibility(FrustumPiramide* Frustum)
{
        // Проверка на попадание BoundingOBB в пирамиду видимости Frustum
...
D3DXVECTOR3 LinePosition = LineStart + LineDirection/2.0;       // Вектор в середину линии
        // 1/2 дляны линии
float LineLength2 = (sqrt(LineDirection.x*LineDirection.x+LineDirection.y*LineDirection.y+LineDirection.z*LineDirection.z))/2.0;
